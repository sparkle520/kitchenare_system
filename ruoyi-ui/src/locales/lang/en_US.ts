export default {
  ...
  common: {
    ...
    copyright: `Copyright © 2021-${new Date().getFullYear()} ${import.meta.env.VITE_APP_COMPANY_NAME}. All Rights Reserved`,
    conjunction: 'and',
    admin: 'admin',
  },
  components: {
  ...
  pages: {
    ...
    user: {
      ...
      account: 'My Account',
      organization:
        'Tencent / Tencent Company / Business Group / Product Department / Operations Center / Merchant Services Group',
      personalInfo: {
        title: 'Personal Info',
