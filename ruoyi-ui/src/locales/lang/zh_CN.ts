export default {
  ...
  common: {
    ...
    copyright: `版权所有 © 2021-${new Date().getFullYear()} ${import.meta.env.VITE_APP_COMPANY_NAME} 保留所有权利`,
    conjunction: '和',
    admin: 'admin',
  },
  components: {
  ...
  pages: {
    ...
    detailBase: {
      ...
      sampleData: {
        contractName: '总部办公用品采购项目',
        status: '履行中',
        company: '腾讯科技（深圳）有限公司',
        employee: '欧尚',
        fileName: '总部办公用品采购项目合同.pdf',
      },
      changelog: {
        title: '变更记录',
        step1: {
    ...
    detailCard: {
      ...
      products: {
        ...
        product2: {
          ...
          company: '微软（Microsoft Corporation）',
          size: '12.4 英寸',
          cpu: 'Core i7',
          memory: 'RAM 16GB',
    ...
    listBase: {
      ...
      receive: '收款',
      placeholder: '请输入内容搜索',
      deleteConfirm: '确认删除当前所选合同？',
      deleteTip: '删除后，{name}的所有合同信息将被清空，且无法恢复',
      contractStatusEnum: {
        fail: '审核失败',
        audit: '待审核',
        executing: '履行中',
    ...
    user: {
      ...
      unit: '（次）',
      account: 'My Account',
      organization: '腾讯/腾讯公司/某事业群/某产品部/某运营中心/商户服务组',
      personalInfo: {
        title: '个人信息',
